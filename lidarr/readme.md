...
2. Download the [scripts_init.bash](https://github.com/rairulyle/arr-scripts/blob/main/lidarr/scripts_init.bash) ([Download Link](https://raw.githubusercontent.com/rairulyle/arr-scripts/main/lidarr/scripts_init.bash)) and place it into the following folder:
   `/custom-cont-init.d`
...
1. Download/update your local `/config/extended.conf` file with the latest options from: [extended.conf](https://github.com/rairulyle/arr-scripts/blob/main/lidarr/extended.conf)
...
[Information](https://github.com/rairulyle/arr-scripts/tree/main?tab=readme-ov-file#support-info)

## Features

<table>
  <tr>
    <td><img src="https://github.com/rairulyle/docker-lidarr-extended/raw/main/.github/lidarr.png" width="150"></td>
    <td><img src="https://github.com/rairulyle/docker-lidarr-extended/raw/main/.github/plus.png" width="75"></td>
    <td><img src="https://github.com/rairulyle/docker-lidarr-extended/raw/main/.github/music.png" width="150"></td>
    <td><img src="https://github.com/rairulyle/docker-lidarr-extended/raw/main/.github/plus.png" width="75"></td>
    <td><img src="https://github.com/rairulyle/docker-lidarr-extended/raw/main/.github/video.png" width="150"></td>
  </tr>
 </table>
...
For more details, visit the [Wiki](https://github.com/rairulyle/arr-scripts/wiki/Lidarr)

### Audio & Video (Plex Example)

![plex](https://github.com/rairulyle/docker-lidarr-extended/raw/main/.github/plex.png)

### Video Example (Kodi)

![kodi](https://github.com/rairulyle/docker-lidarr-extended/raw/main/.github/kodi-music-videos.png)
