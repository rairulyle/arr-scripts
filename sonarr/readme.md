...
2. Download the [script_init.bash](https://github.com/rairulyle/arr-scripts/blob/main/sonarr/scripts_init.bash) ([Download Link](https://raw.githubusercontent.com/rairulyle/arr-scripts/main/sonarr/scripts_init.bash)) and place it into the following folder: `/custom-cont-init.d`
...
1. Download/update your local `/config/extended.conf` file with the latest options from: [extended.conf](https://github.com/rairulyle/arr-scripts/blob/main/sonarr/extended.conf)
...
<table>
  <tr>
    <td><img src="https://raw.githubusercontent.com/rairulyle/unraid-templates/master/rairulyle/img/sonarr.png" width="200"></td>
    <td><img src="https://github.com/rairulyle/docker-lidarr-extended/raw/main/.github/plus.png" width="100"></td>
    <td><img src="https://raw.githubusercontent.com/rairulyle/unraid-templates/master/rairulyle/img/amtd.png" width="200"></td>
  </tr>
 </table>
...
For more details, visit the [Wiki](https://github.com/rairulyle/arr-scripts/wiki)

### Plex Example

![amvtd](https://raw.githubusercontent.com/rairulyle/docker-amtd/master/.github/amvtd-plex-example.jpg)
