...
1. Download the [script_init.bash](https://github.com/rairulyle/arr-scripts/blob/main/readarr/scripts_init.bash) ([Download Link](https://raw.githubusercontent.com/rairulyle/arr-scripts/main/readarr/scripts_init.bash)) and place it into the following folder: `/custom-cont-init.d`
...
1. Download/update your local `/config/extended.conf` file with the latest options from: [extended.conf](https://github.com/rairulyle/arr-scripts/blob/main/readarr/extended.conf)
